...
@EnableZuulProxy
public class SampleWithAngularApp {

    private static final Logger log = LoggerFactory.getLogger(SampleWithAngularApp.class);

    private final Environment env;

    public SampleWithAngularApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes SampleWithAngular.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SampleWithAngularApp.class);
